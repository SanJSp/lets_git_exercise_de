...
#### Files
If you don't know how to create a title, take a look at this cheat sheet.
https://guides.github.com/pdfs/markdown-cheatsheet-online.pdf

#### Tasks
Do these following steps:
- [ ] Create a new Branch "feature1_new_title"
- [ ] Checkout feature1_new_title
- [ ] Add a title to the index.md file using github flavoured markdown (see files if you need help)
